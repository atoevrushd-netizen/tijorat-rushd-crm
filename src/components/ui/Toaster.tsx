    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(5rem+env(safe-area-inset-bottom))] z-[60] flex flex-col items-center gap-2 px-4 sm:bottom-6">
      {items.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className="pointer-events-auto flex w-full max-w-sm animate-sheet-up items-center gap-3 rounded-[16px] border border-line bg-elevated px-4 py-3 shadow-sh2"
          >
