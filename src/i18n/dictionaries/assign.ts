...
const bundle: Record<Lang, Record<string, string>> = {
  tg: {
    ...
    'assign.windowBlocked': 'Дар байни интихобшудагон резиденти бе обуна ҳаст ё давраҳо бо ҳам мувофиқ намеоянд — резидентҳои дорои давраи умумӣ интихоб кунед.',
  },
  ru: {
    ...
    'assign.windowBlocked': 'Среди выбранных есть резидент без подписки или периоды не пересекаются — выберите резидентов с общим периодом.',
  },
}
