      ...
      {open &&
        createPortal(
          <>
            ...
            <div className="fixed right-3 top-[64px] z-[57] w-[min(360px,calc(100vw-1.5rem))] overflow-hidden rounded-[18px] border border-line bg-surface shadow-sh1 sm:right-6">
