...
export function MonthHero({ month }: { month: MonthSummary }) {
  ...
  return (
    <div className="rounded-[22px] border border-line bg-surface p-5 shadow-sh1 sm:p-6">
      <div className="flex flex-col items-center gap-5 sm:flex-row sm:gap-7">
        ...
        <div className="min-w-0 flex-1 text-center sm:text-left">
          ...
          <h3 className="mt-0.5 text-[22px] font-extrabold capitalize text-ink">{name}</h3>
