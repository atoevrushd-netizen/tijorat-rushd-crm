...
const bundle: Record<Lang, Record<string, string>> = {
  tg: {
    ...
    'nav.myData': 'Маълумотам',
    'nav.mySurvey': 'Анкета',
    'nav.assignTask': 'Таъин',
    'page.assignTask': 'Таъини задача',
    'page.users': 'Корбарон',
    'page.dashboard': 'Дашборд',
    'page.tabs': 'Идоракунии бахшҳо',
    'page.userCard': 'Корти корбар',
  ...
  ru: {
    ...
    'nav.mySurvey': 'Анкета',
    'nav.assignTask': 'Назначить',
    'page.assignTask': 'Назначить задачу',
